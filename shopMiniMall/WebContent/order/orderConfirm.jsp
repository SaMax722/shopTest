	...
	<table width="80%" cellspacing="0" cellpadding="0">
			...
			<td>
				<table width="100%" cellspacing="0" cellpadding="0" border="1"
					...
					<tr>
						...
						<td height="35" class="td_default"><input
							class="input_default" type="text" id="mpost" value="${mDTO.post}"
							readonly></input></td>
					</tr>
					<tr>
		...
		<tr>
			<td class="td_default"><input type="checkbox"
				name="same_address" id="same_addr"> 배송지가 동일할 경우 선택하세요.</td>
		</tr>
		<!--  배송지 정보 시작-->
		<tr>
			<td height="30">
				...
				<table width="100%" cellspacing="0" cellpadding="0" border="1"
					...
					<tr>
						...
						<td height="35" class="td_default">
							<!-- 다음주소 시작--> <input type="text" id="sample4_postcode"
							placeholder="우편번호"> <input type="button"
							onclick="sample4_execDaumPostcode()" value="우편번호 찾기"><br>
							<input type="text" id="sample4_roadAddress" placeholder="도로명주소">
							<input type="text" id="sample4_jibunAddress" placeholder="지번주소">
							<span id="guide" style="color: #999"></span> <script
		...
		<tr>
			<td class="td_default" align="center"><input type='button'
				...
				type='button' value='결제하기' onclick="orderDone(myForm)"></td>
		</tr>
